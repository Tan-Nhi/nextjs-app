...
import { PauseCircle, PauseCircleFilled, PauseCircleFilledOutlined, PlayArrow } from '@mui/icons-material';
...
const WaveTrack = () => {
    ...
    const calLeft = (moment: number) => {
        const hardCodedDuration = 199; // in seconds
                ...
                >
                    ...
                    >
                        <div>
                            ...
                            >
                                {isPlaying === true ?
                                    <PauseCircleIcon sx={{ fontSize: 30, color: '#fff' }} />
                                    :
                                ...
                                arrComments.map((item) => {
                                    return (
                                        <Tooltip title={item.content} arrow>
                                            <img src={`http://localhost:8000/images/chill1.png`}
                                                onPointerMove={(e) => {
                                                    const hover = hoverRef.current!;
